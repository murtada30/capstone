...
contract Ownable {
    ...
    modifier onlyOwner(){
        ...
        require(msg.sender == _owner, "This function can be only called by contract owner");
        _;
    }
...
contract Pausable is Ownable {
    ...
    event Unpaused(address triggeredBy);
     ...
     modifier whenNotPaused(){
        ...
        require(_paused == false, "contract must be not pused for this function to run");
        _;
    }

    modifier paused(){

        require(_paused == true, "contract must be  pused for this function to run");
        _;
    }

    function setPausedStatus(bool pauseStatus)
    onlyOwner
    public
    {
        _paused = pauseStatus;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Address is owner of token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        bool isApprovedBool = isApprovedForAll(ownerOf(tokenId), msg.sender);

        require(msg.sender == ownerOf(tokenId) || isApprovedBool, " msg sender must be the owner of the contract or is approved to be true");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "token is invlid and it does not exist");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "invalid address for mint");
        require(!_exists(tokenId), "token  already availble");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Invlid Address (To)");
...
contract MyERC721Token is ERC721Metadata("My Real State", "RS", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
